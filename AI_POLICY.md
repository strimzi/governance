...
* **Use AI as a learning tool.** New contributors could use AI tools to understand the codebase. If you're using AI to generate code you don't understand, take time to learn the concepts before submitting.
...
* **When disclosure is required:** Disclosure is required when AI tools generate substantial content. Using AI features similar to IDE capabilities does not require disclosure.
...
* **Focus on quality, not quantity.** Do not open multiple AI-generated PRs in rapid succession. Submitting many PRs at once or within a few minutes overwhelms reviewers and will result in PRs being closed.
